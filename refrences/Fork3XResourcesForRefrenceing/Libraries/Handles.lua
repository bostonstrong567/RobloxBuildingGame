...
function Handles:CreateHandles(Options)
	...
	for _, Side in ipairs(Enum.NormalId:GetEnumItems()) do
		...
		--		HandleMaid[Side.Name .. "HoverChanged"] = Support.AddUserInputListener('Changed', {'MouseMovement', 'Touch'}, true, IsInHandle)
