...
local InstancePool = require(script.Parent.Parent.Libraries.InstancePool)
...
local HighlightPool = InstancePool.new(20, function ()
	return Core.Make('SelectionBox')(Core.Options.BoundingBoxHighlightMake(Core))
end)
